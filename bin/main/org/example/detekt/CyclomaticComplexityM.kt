...
class CyclomaticComplexityM(config: Config) : Rule(config) {
    ...
    private val threshold = valueOrDefault("threshold", 15)
    ...
    override fun visitNamedFunction(function: KtNamedFunction) {
        ...
        val complexity = CyclomaticComplexity.calculate(function) {
            this.ignoreSimpleWhenEntries = this@CyclomaticComplexityM.ignoreSimpleWhenEntries
            this.ignoreNestingFunctions = this@CyclomaticComplexityM.ignoreNestingFunctions
            this.nestingFunctions = this@CyclomaticComplexityM.nestingFunctions
        }
